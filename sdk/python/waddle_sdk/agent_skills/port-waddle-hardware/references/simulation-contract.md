...
variation from that seed, preserving assembled bodies as rigid groups. Their seed
zero and ordinary reset select the canonical interactive scene. A custom backend
may use a different finite distribution, but equal seeds must reproduce equal complete
