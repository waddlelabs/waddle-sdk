...
def objects(environment: str, *, robot: str | None = None) -> list[list[Link]]:
    ...
    if environment == "candy-bin-transfer":
        ...
        placements = (
            (0.229, -0.248, 0.016, 0.0, 0.0, 0.12),
            (0.271, -0.251, 0.016, 0.0, 0.0, -0.21),
            (0.316, -0.244, 0.016, 0.0, 0.0, 0.34),
            (0.362, -0.249, 0.016, 0.0, 0.0, -0.16),
            (0.247, -0.216, 0.016, 0.0, 0.0, 0.48),
            (0.291, -0.220, 0.016, 0.0, 0.0, -0.39),
            (0.337, -0.211, 0.016, 0.0, 0.0, 0.19),
            (0.372, -0.202, 0.016, 0.0, 0.0, -0.52),
            (0.228, -0.177, 0.016, 0.0, 0.0, -0.27),
            (0.268, -0.182, 0.016, 0.0, 0.0, 0.37),
            (0.316, -0.176, 0.016, 0.0, 0.0, -0.46),
            (0.361, -0.168, 0.016, 0.0, 0.0, 0.24),
            (0.252, -0.234, 0.043, 0.18, -0.10, -0.63),
            (0.299, -0.232, 0.042, -0.14, 0.12, 0.71),
            (0.345, -0.226, 0.044, 0.10, 0.16, -0.32),
            (0.244, -0.193, 0.042, -0.12, -0.15, 0.66),
            (0.292, -0.197, 0.044, 0.15, -0.11, -0.74),
            (0.343, -0.189, 0.043, -0.16, 0.09, 0.43),
        )
        candies = []
        for index, (x, y, z, roll, pitch, yaw) in enumerate(placements, start=1):
            candy = Link(
                ...
                kind="free",
                mass=0.006,
                inertia=(2.0e-7, 4.6e-7, 5.2e-7, 0.0, 0.0, 0.0),
                shapes=[
                    Shape("box", (0.018, 0.016, 0.012), color=candy_color),
                    Shape(
                        "box",
                        (0.006, 0.010, 0.004),
                        (-0.012, 0.0, 0.0),
