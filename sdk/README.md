...
agent configuration. Interpreter-generated bytecode and cache directories are excluded,
so the result contains only the packaged, version-matched resources. The porting skill
scaffolds and validates non-opening adapter code; it contains no live-motion or automatic
