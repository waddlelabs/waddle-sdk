...
The sixteen MuJoCo-only development task environments are built-in interactive
fixtures using the same runtime surface. Eleven are single-arm and five are
